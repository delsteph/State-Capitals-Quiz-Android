...
public class QuizDataDBHelper extends SQLiteOpenHelper {
    ...
    public static final String QUIZQUESTIONS_COLUMN_ANSWER = "answer";

    public static final String TABLE_QUIZRESULTS = "quizresults";
    public static final String QUIZRESULTS_COLUMN_ID = "_id";
    public static final String QUIZRESULTS_COLUMN_DATE = "date";
    public static final String QUIZRESULTS_COLUMN_RESULT = "result";
    ...
    private static final String CREATE_QUIZQUESTIONS =
            "create table " + TABLE_QUIZQUESTIONS + " ("
                    ...
                    + QUIZQUESTIONS_COLUMN_ANSWER + " TEXT"
                    + ")";
    ...
    private static final String CREATE_QUIZRESULTS =
            "create table " + TABLE_QUIZRESULTS + " ("
                    ...
                    + QUIZRESULTS_COLUMN_DATE + " DATE, "
                    + QUIZRESULTS_COLUMN_RESULT + " INT "
                    + ")";
    ...
    public static synchronized QuizDataDBHelper getInstance( Context context ) {
